...
@Component({
  selector: 'app-assi9-rective-form',
  templateUrl: './assi9-rective-form.component.html',
  styleUrls: ['./assi9-rective-form.component.css']
})
export class Assi9RectiveFormComponent implements OnInit {
